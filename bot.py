...
def wallet_keyboard():
    ...
    # Two buttons per row, as requested.
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("🟢 Deposit", callback_data="wallet_deposit"),
                InlineKeyboardButton("🔵 Withdrawal", callback_data="wallet_withdraw"),
            ],
            [
    ...
    if query.data == "admin_txs":
        ...
        for tx in txs:
            buttons = [
                InlineKeyboardButton(
                    "✅ Approve",
                    callback_data=f"tx_app_{tx['tx_id']}",
                ),
                InlineKeyboardButton(
                    "❌ Reject",
                    callback_data=f"tx_rej_{tx['tx_id']}",
                ),
            ]
